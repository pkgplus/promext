...
var (
	MetricsDict = []Metric{
		...
		Metric{"diskUtilization", MetricType_Current, `100 - node_filesystem_free{$filter, fstype!~"rootfs|selinuxfs|autofs|rpc_pipefs|tmpfs|iso.+"} / node_filesystem_size * 100`},
